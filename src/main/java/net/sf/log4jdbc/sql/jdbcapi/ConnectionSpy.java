 ...
 *
 * <p>This version is for jdbc 4.</p>
 *
 * @author Arthur Blake
...
public class ConnectionSpy implements Connection, Spy {
     ...
     *
     * @param methodCall the method call that threw the exception
     * @param exception  the exception that was thrown
     * @param sql        the sql that was being executed when the exception occurred
     */
     ...
     * @param methodCall the method call that threw the exception
     * @param exception  the exception that was thrown
     * @param execTime   the time in ms taken to execute the method that threw the exception
     */
     ...
     *
     * @param methodCall  the method call that threw the exception
     * @param returnValue the return value of the method that threw the exception
     */
     ...
     *
     * @param methodCall the method call that threw the exception
     * @param value      the value of the method that threw the exception
     * @return the value of the method that threw the exception
     */
    ...
    public <T> T unwrap(Class<T> iface) throws SQLException {
        ...
        try {
            ...
            return reportReturn(methodCall, ((iface == Connection.class || iface == Spy.class)) ?
