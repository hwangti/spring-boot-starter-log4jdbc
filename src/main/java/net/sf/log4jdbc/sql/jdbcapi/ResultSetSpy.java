...
public class ResultSetSpy implements ResultSet, Spy {
    ...
    /**
     * The real ResultSet that this ResultSetSpy wraps.
     */
     ...
     * @param returnValue Object that was returned.
     * @param methodParams arguments passed to the method that returned.
     */
    ...
    /**
     * @return the connection number of the parent statement.
     */
     ...
     * @param methodCall  description of method call and arguments passed to it that returned.
     * @param returnValue Object that was returned.
     * @param args        arguments passed to the method that returned.
    ...
    public <T> T unwrap(Class<T> iface) throws SQLException {
        ...
        try {
            ...
            return reportReturn(methodCall, ((iface == ResultSet.class || iface == Spy.class)) ?
