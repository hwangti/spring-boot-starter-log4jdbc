...
public class StatementSpy implements Statement, Spy {
    ...
    /**
     * The SpyLogDelegator that we use to log our events.
     */
    ...
    /**
     * Report (for logging) that a method returned.  All the other reportReturn methods are convenience methods that call this method.
     *
    ...
    /**
     * Convenience method to report (for logging) that a method returned a boolean value.
     *
     * @param methodCall description of method call and arguments passed to it that returned.
    ...
    /**
     * Convenience method to report (for logging) that a method returned a byte value.
     *
     * @param methodCall description of method call and arguments passed to it that returned.
    ...
    /**
     * Convenience method to report (for logging) that a method returned an int value.
     *
     * @param methodCall description of method call and arguments passed to it that returned.
    ...
    /**
     * Convenience method to report (for logging) that a method returned a double value.
     *
     * @param methodCall description of method call and arguments passed to it that returned.
    ...
    /**
     * Convenience method to report (for logging) that a method returned a short value.
     *
     * @param methodCall description of method call and arguments passed to it that returned.
    ...
    /**
     * Convenience method to report (for logging) that a method returned a long value.
     *
     * @param methodCall description of method call and arguments passed to it that returned.
    ...
    /**
     * Convenience method to report (for logging) that a method returned a float value.
     *
     * @param methodCall description of method call and arguments passed to it that returned.
    ...
    /**
     * Convenience method to report (for logging) that a method returned (void return type).
     *
     * @param methodCall description of method call and arguments passed to it that returned.
     */
    ...
    protected ResultSet getGeneratedKeys(String sql) throws SQLException {
        ...
        try {
            ...
            if (r == null) {
                return (ResultSet) reportReturn(methodCall, null);
            }
    ...
    public <T> T unwrap(Class<T> iface) throws SQLException {
        ...
        try {
            ...
            return (T) reportReturn(methodCall, ((iface == Connection.class || iface == Spy.class)) ?
                    this : realStatement.unwrap(iface));
        } catch (SQLException s) {
            reportException(methodCall, s);
            throw s;
        }
    ...
    public boolean isWrapperFor(Class<?> iface) throws SQLException {
        ...
        try {
            return reportReturn(methodCall, ((iface == Statement.class || iface == Spy.class)) ||
