...
public interface ResultSetCollector {
     ...
     *
     * @param resultSetSpy the ResultSetSpy instance that is calling this method
     * @param methodCall   the method that is being called
     * @param returnValue  the return value of the method
     * @param targetObject the object that the method is being called on
    ...
    /**
     * Get the result set column name for a given column number previously obtained
     ...
     * This method is usually called under the hood by the <code>ResultSetCollector</code>
     ...
     *
     * @param rs The real JDBC <code>ResultSet</code> that was wrapped into a <code>ResultSetSpy</code>.
     */
