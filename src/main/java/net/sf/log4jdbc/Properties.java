 ...
 * <b>Modifications for log4jdbc</b>
 * <ul>
...
public final class Properties {
    ...
    /**
     * Flag to indicate debug trace info should be from the calling application point of view
     * (true if DebugStackPrefix is set.)
     */
     ...
     * long or more to run shall cause a warning message to be generated on the SQL timing logger.
    ...
    /**
     * An amount of time in milliseconds for which SQL that executed taking this
     * long or more to run shall cause an error message to be generated on the SQL timing logger.
     ...
     * than the SQL will be broken up into lines that are no longer than this value.
     */
     ...
     * (as opposed to a PreparedStatement.)
     * Using Statements for frequently used SQL can sometimes result in performance and/or security problems.
     */
     ...
     * By default, all 5 of the following will be true.
     * If any one is set to false, then that particular type of SQL will not be dumped.
     */
     ...
     * This will result in a VERY voluminous output, but can be very useful under some circumstances.
     */
     ...
     * Only when 2 or more lines in a row like this occur, will the extra lines (beyond 1) be removed.
     */
    ...
    static final boolean FormatSql;
    ...
    static {
        ...
        // (as long as this class is not fully initialized, SpyLogFactory cannot determine which logger to use)
        ...
        // and now we set all the other properties, with proper logging messages here,
        // this method should have been already called by preLoggerInitialization(),
        // but we use it again here so that we can log where the properties come from.
        ...
        DumpSqlMaxLineLength = getLongOption(props,
                "log4jdbc.dump.sql.maxlinelength", 0).intValue();
    ...
    /**
     * Get the <code>java.util.Properties</code> either from the System properties, or from a configuration file.
     * Events will be logged only if <code>#log</code> has already been set, and this method will not try to load it:
     * this method can be called before the properties needed to know which <code>SpyLogDelegator</code>
     * to use are loaded, and it would generate an error to try to load it.
    ...
    /**
     * Get the dumpSqlMaxLineLength option.
     *
    ...
    /**
     * Get the dumpSqlAddSemicolon option.
     *
    ...
    /**
     * Get the trimExtraBlankLinesInSql option.
     *
    ...
    /**
     * Get the dumpFullDebugStackTrace option.
     *
    ...
    /**
     * Get the traceFromApplication option.
     *
    ...
    /**
     * Get the debugStackPrefix option.
     *
    ...
    /**
     * Get the dumpSqlFilteringOn option.
     *
    ...
    /**
     * Get the sqlTimingErrorThresholdEnabled option.
     *
    ...
    /**
     * Get the sqlTimingErrorThresholdMsec option.
     *
    ...
    /**
     * Get the sqlTimingWarnThresholdEnabled option.
     *
    ...
    /**
     * Get the sqlTimingWarnThresholdMsec option.
     *
    ...
    /**
     * Get the AutoLoadPopularDrivers option.
     *
    ...
    /**
     * Get the AdditionalDrivers option.
     *
    ...
    /**
     * Get the DumpBooleanAsTrueFalse option.
     *
    ...
    /**
     * Get the StatementUsageWarn option.
     *
    ...
    /**
     * Get the SuppressGetGeneratedKeysException option.
     *
    ...
    /**
     * Get the HighlightSql option.
     *
     * @return the HighlightSql
     */
